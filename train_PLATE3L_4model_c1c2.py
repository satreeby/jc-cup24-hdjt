...
inputs_metal4=torch.tensor(feature_matrix_metal4[1],dtype=torch.float32)
...
inputs_metal5=torch.tensor(feature_matrix_metal5[1],dtype=torch.float32)
...
inputs_metal6=torch.tensor(feature_matrix_metal6[1],dtype=torch.float32)
...
inputs_metal7=torch.tensor(feature_matrix_metal7[1],dtype=torch.float32)
...
# labels
labels_metal1=cap_utils.load_data('./Cases/PLATE3L/SUB-metal1-metal2_PLATE3L/SUB-metal1-metal2_PLATE3L.tbl.text', 0, 324)[model_index_metal1[1],:][:,0:4]
labels_metal2=cap_utils.load_data('./Cases/PLATE3L/SUB-metal2-metal3_PLATE3L/SUB-metal2-metal3_PLATE3L.tbl.text', 0, 324)[model_index_metal2[1],:][:,0:4]
labels_metal3=cap_utils.load_data('./Cases/PLATE3L/SUB-metal1-metal3_PLATE3L/SUB-metal1-metal3_PLATE3L.tbl.text', 0, 324)[model_index_metal3[1],:][:,0:4]
labels_metal4=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/1/final_output.txt', 0, 972)[model_index_metal4[1],:][:,1:5]
labels_metal5=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/2/final_output.txt', 0, 972)[model_index_metal5[1],:][:,1:5]
labels_metal6=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/3/final_output.txt', 0, 972)[model_index_metal6[1],:][:,1:5]
labels_metal7=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/4/final_output.txt', 0, 972)[model_index_metal7[1],:][:,1:5]
...
batch_size=2048
model = CpMLP.CpMLP(inchans=21, hidden1=2048, hidden2=1024, hidden3=512, hidden4=512, hidden5=128, outchans=4)
...
# 保存模型
torch.save(model.state_dict(), './model/PLATE3L/model_PLATE3L_c1c2.pt')
