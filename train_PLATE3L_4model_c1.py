...
inputs_metal6=torch.tensor(feature_matrix_metal6[0],dtype=torch.float32)
...
inputs_metal7=torch.tensor(feature_matrix_metal7[0],dtype=torch.float32)
...
# labels
labels_metal1=cap_utils.load_data('./Cases/PLATE3L/SUB-metal1-metal2_PLATE3L/SUB-metal1-metal2_PLATE3L.tbl.text', 0, 324)[model_index_metal1[0],:][:,[1,2,3]]
labels_metal2=cap_utils.load_data('./Cases/PLATE3L/SUB-metal2-metal3_PLATE3L/SUB-metal2-metal3_PLATE3L.tbl.text', 0, 324)[model_index_metal2[0],:][:,[1,2,3]]
labels_metal3=cap_utils.load_data('./Cases/PLATE3L/SUB-metal1-metal3_PLATE3L/SUB-metal1-metal3_PLATE3L.tbl.text', 0, 324)[model_index_metal3[0],:][:,[1,2,3]]
labels_metal4=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/1/final_output.txt', 0, 972)[model_index_metal4[0],:][:,[2,3,4]]
labels_metal5=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/2/final_output.txt', 0, 972)[model_index_metal5[0],:][:,[2,3,4]]
labels_metal6=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/3/final_output.txt', 0, 972)[model_index_metal6[0],:][:,[2,3,4]]
labels_metal7=cap_utils.load_data('./Cases/PLATE3L/PLATE3L_single_expand/4/final_output.txt', 0, 972)[model_index_metal7[0],:][:,[2,3,4]]
...
batch_size=128
model = CpMLP.CpMLP(inchans=15, hidden1=2048, hidden2=1024, hidden3=1024, hidden4=512, hidden5=128, outchans=3)
...
# 保存模型
torch.save(model.state_dict(), './model/PLATE3L/model_PLATE3L.pt')
